...
import { fetchProcessByStageFour } from "../../services";
...
class CreateDogovor extends Component {
    constructor(props) {
        super(props);
        this.state = this.initialState;
        this.state = {
        processId : 0,
        name: "Договор на оказание услуг от программной поддержки",
        content: "",
        process: [],
        show: false,
        };
      ...
      render() {
        const { processId, name, content} = this.state;
        return (
          <div>
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(CreateDogovor);